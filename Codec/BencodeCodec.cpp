...
void BencodeCodec::Decode(std::istream &stream, ojson &root) const { root = DecodeOneValue(stream); }

void BencodeCodec::Encode(std::ostream &stream, ojson const &root) const { EncodeOneValue(stream, root); }
